...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row align-items-center min-vh-36">
            <!-- col -->
            <div class="col-lg-6 col-md-12 col-12">
                <div class="px-xl-20 px-md-8 px-4 py-8 py-lg-0">
                    ...
                    <div class="text-dark">
                        <h1 class="display-4 fw-bold">Мы рядом</h1>
                        ...
                        <div class="mt-8">
                            ...
                            <p class="fs-4"><i class="fa fa-phone text-primary
                    me-2"></i> + 7 999 585 4770</p>
                            <p class="fs-4"><i class="fa fa-envelope-open
                    text-primary me-2"></i> techfox@techfox.com</p>
                            <p class="fs-4 d-flex"><i class="fa fa-map-marker-alt
                    text-primary me-2"></i> Энтузиастов 17, 454020</p>
                        </div>
                        <div class="mt-10">
                            <!--Facebook-->
